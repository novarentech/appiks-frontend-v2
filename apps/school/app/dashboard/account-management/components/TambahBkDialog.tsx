...
export function TambahBkDialog({
  open,
  onOpenChange,
  onAdd,
}: TambahBkDialogProps) {
        ...
        <DialogHeader>
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left pb-2">
            ...
            <div className="space-y-1">
              <DialogTitle>Tambah Akun Guru BK</DialogTitle>
              <DialogDescription>
                Lengkapi formulir di bawah ini untuk membuat akun guru bimbingan konseling baru.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
